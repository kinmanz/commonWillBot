...
def send_welcome(message):
    if in_private(message):
        ...
        bot.send_message(
            ...
            f"{EMOJI.POINT_RIGHT} Если хочешь проверить как будет выглядить твой пост, используй тег #dry_run \n"
            "Если тебе охота сказать последнее слово, используй тег #last_will\n"
